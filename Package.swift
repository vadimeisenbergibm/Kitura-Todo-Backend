...
let package = Package(
    name: "Kitura-Todo-Backend-InMemory",
    dependencies: [
      .package(url: "https://github.com/IBM-Swift/Kitura.git", .upToNextMajor(from: "2.0.0")),
      .package(url: "https://github.com/vadimeisenbergibm/Todo-Backend-InMemory-DataLayer.git",
                   .upToNextMajor(from: "0.0.0")),
      .package(url: "https://github.com/vadimeisenbergibm/Todo-Backend-Router.git",
                     .upToNextMajor(from: "0.0.0")),
